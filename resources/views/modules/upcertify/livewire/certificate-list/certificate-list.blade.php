                    ...
                    <li>
                        <div class="uc-certificates_item">
                            ...
                            <div class="uc-certificates_item_content">
                                <div class="uc-certificates_item_header">
                                    <h3 class="uc-certificates_item_title">{{ $template->title }}</h3>
                                    <div class="uc-certificates_item_meta">
                                        <span class="uc-certificates_item_label">
                                            <i class="am-icon-book-1"></i>
                                            {{ __('coursebundles::bundles.created_by') }}:
                                        </span>
                                        <em class="uc-certificates_item_author">
                                            {{ $template->createdBy?->profile?->first_name }}
                                            {{ $template->createdBy?->profile?->last_name }}
                                        </em>
                                    </div>
                                </div>

                                <div class="uc-certificates_item_actions">
                                    <button type="button" class="uc-certificates_item_actions_btn">
                                        <i><x-upcertify::icons.ellipsis-horizontal /></i>
                                    </button>
