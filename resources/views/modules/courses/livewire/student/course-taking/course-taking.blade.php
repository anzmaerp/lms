                                    ...
                                    <div class="cr-sidebar_accordion_content_item">
                                        ...
                                        >
                                            ...
                                            <i>
                                                ...
                                                @elseif($curriculum->type == 'pdf')
                                                    <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="#585858" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
...
@elseif($activeCurriculum['type'] == 'yt_link')
        ...
        <div x-data="{
            ...
            <iframe
                ...
                allowfullscreen
            ></iframe>
        </div>@elseif($activeCurriculum['type'] == 'vm_link')
        @php
            $videoId = '';
                                    ...
                                    @if(empty($studentRating))
                                        <div class="cr-course-includes cr-course-rating-wrap">
                                            ...
                                            <div class="cr-rating-form" x-data="{ show: false, description: @entangle('description') }">
                                                <textarea class="form-control" placeholder="{{ __('courses::courses.rating_description') }}" x-model="description"></textarea>
                                    ...
                                    <li>
                                        <div class="am-tutorreview-item">
                                            ...
                                            <span>{{ number_format($course->active_students_count) }}
                                                <em>{{ $course->active_students_count == 1 ? __('courses::courses.active_student') : __('courses::courses.active_students') }}</em>
                                            </span>
                                        </div>
                                    </li>
                                    <li>
