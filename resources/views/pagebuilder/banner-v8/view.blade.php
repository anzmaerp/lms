<div class="splide am-banner-slider banner-v8-slider" id="hero-slider" dir='ltr'>
                            ...
                            <div class="am-banner-content">
                                <div class="am-hero-content">
                                    ...
                                    @if (!empty($option['heading']))
                                        <h1 class="am-hero-title"> {!! $option['heading'] !!} </h1>
                                    @endif
                                </div>
                                <div class="am-hero-description-wrapper">
                                    @if (!empty($option['paragraph']))
                                        <p class="am-hero-description"> {!! $option['paragraph'] !!} </p>
                                    @endif
                                    <div class="am-partner-logos">
                                        @if (!empty($option['companies_images']))
                                            @foreach ($option['companies_images'] as $image)
                                                @if (!empty($image['path']))
                                                    <img src="{{ Storage::url($image['path']) }}" alt="Company image"
                                                        class="am-partner-logo">
                                                @endif
                                            @endforeach
                                        @endif
                                    </div>
