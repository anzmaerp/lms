            ...
            <fieldset>
                <div class="am-themeform__wrap">
                    <div class="form-group-wrap">
                        ...
                        <div class="form-group {{ $errors->has('gender') ? 'am-invalid' : '' }} am-form-groupradio">
                            <x-input-label for="gender" :value="__('auth.gender')" class="am-important" />
                            <div class="am-radio">
                                <input type="radio" id="gender_male" name="gender" wire:model="gender" value="1"
                        ...
                        <div class="form-group">
                            <x-primary-button wire:target="register"
                                wire:loading.class="am-btn_disable"><span>{{ __('auth.register') }}</span><i
