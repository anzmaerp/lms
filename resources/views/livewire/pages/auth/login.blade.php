...
new #[Layout('layouts.guest')] class extends Component {
    ...
    public function login(): void
    {
        ...
        if (isActiveModule('ipmanager') && !empty($this->userLogData)) {
            createUserLog($this->userLogData);
        }
            ...
            <fieldset>
                <div class="am-themeform__wrap">
                    <div class="form-group-wrap">
                        <div class="form-group {{ $errors->get('form.username') ? 'am-invalid' : '' }}">
                            <x-input-label class="am-important" for="username" :value="__('auth.username_placeholder')" />
                            <x-text-input x-model="form.username" id="username" wire:model="form.username"
                                placeholder="{{ __('auth.username_placeholder') }}" type="text" autofocus />
                            <x-input-error field_name="form.username" />
                        </div>
                        ...
                        @if (isDemoSite())
                            <div class="form-group">
                                @php
                                    $tutor_name = !empty(setting('_lernen.tutor_display_name'))
                                        ? setting('_lernen.tutor_display_name')
                                        : __('general.tutor');
                                    $student_name = !empty(setting('_lernen.student_display_name'))
                                        ? setting('_lernen.student_display_name')
                                        : __('general.student');
                                @endphp
