                        ...
                        <fieldset>
                            <div class="form-group">
                                ...
                                <div class="form-group-two-wrap">
                                    <div @class([
                                        'form-control_wrap',
                                        'am-invalid' => $errors->has('form.name'),
                                    ])>
                                        <x-text-input wire:model="form.name" placeholder="{{ __('profile.full_name') }}"
                                    ...
                                    @if ($enableGooglePlaces == '1')
                                        <div class="form-group">
                                            <div @class([
                                                ...
                                                <x-text-input wire:ignore.self id="user_address"
                                                    placeholder="{{ __('profile.address_placeholder') }}" type="text"
                                    ...
                                    @else
                                                ...
                                                <div @class([
                                                    ...
                                                    <span class="am-select" wire:ignore>
                                                        <select class="am-select2" data-componentid="@this"
                                                            data-live="true" data-searchable="true" id="user_country"
                                            ...
                                            <div class="form-group-half">
                                                ...
                                                <div @class([
                                                    ...
                                                    <span class="am-select">
                                                        <select data-componentid="@this" class="am-select2"
                                                            data-searchable="true" id="country_state"
                                        ...
                                        <div class="form-group-half">
                                            <div @class([
                                                ...
                                                <x-text-input wire:model="form.city"
                                                    placeholder="{{ __('profile.city_placeholder') }}" type="text"
                                                    autofocus autocomplete="name" />
                                        ...
                                        <div class="form-group-half">
                                            ...
                                            <div @class([
                                                ...
                                                <x-text-input wire:model="form.zipcode"
                                                    placeholder="{{ __('profile.zipcode_placeholder') }}"
                                                    type="text" autofocus autocomplete="name" />
                                    ...
                                    <div class="am-uploadoption" x-data="{ isUploading: false }"
                                        ...
                                        @if (!empty($form->identificationCard))
                                            <div class="am-uploadedfile">
                                                ...
                                                @endif
                                                <a href="#"
                                                    wire:click.prevent="removeMedia('identificationCard')"
                                                    class="am-delitem">
                                                    <i class="am-icon-trash-02"></i>
                                                </a>
                                            </div>
                            ...
                            @if ($user->hasRole('student'))
                                <div class="form-group">
                                    ...
                                    <div class="form-group-two-wrap">
                                        <div @class([
                                            'form-control_wrap',
                                            'am-invalid' => $errors->has('form.schoolId'),
                                        ])>
                                            <x-text-input wire:model="form.schoolId"
                                                placeholder="{{ __('profile.school_enrollment_id') }}" type="text"
                                                autofocus autocomplete="name" />
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="form-group-two-wrap">
                                        <div @class([
                                            'form-control_wrap',
                                            'am-invalid' => $errors->has('form.schoolName'),
                                        ])>
                                            <x-text-input wire:model="form.schoolName"
                                                placeholder="{{ __('profile.school_name') }}" type="text"
                                                autofocus autocomplete="name" />
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="form-group-two-wrap">
                                        <div @class([
                                            'form-control_wrap',
                                            'am-invalid' => $errors->has('form.parentName'),
                                        ])>
                                            <x-text-input wire:model="form.parentName"
                                                placeholder="{{ __('profile.parent_name') }}" type="text"
                                                autofocus autocomplete="name" />
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="form-group-two-wrap">
                                        <div @class([
                                            'form-control_wrap',
                                            'am-invalid' => $errors->has('form.parentEmail'),
                                        ])>
                                            <x-text-input wire:model="form.parentEmail"
                                                placeholder="{{ __('profile.parent_email') }}" type="text"
                                                autofocus autocomplete="name" />
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="form-group-two-wrap">
                                        <div @class([
                                            'form-control_wrap',
                                            'am-invalid' => $errors->has('form.parentPhone'),
                                        ])>
                                            <x-text-input wire:model="form.parentPhone"
                                                placeholder="{{ __('profile.parent_phone') }}" type="text"
                                                autofocus autocomplete="name" />
