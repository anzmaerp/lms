                                    ...
                                    <div class="tb-select">
                                        <select data-componentid="@this" class="am-select2 form-control"
                                            ...
                                            <option value="student"
                                                ...
                                                {{ $student_name }}</option>
                                            <option value="tutor"
                                                {{ $roles == 'tutor' || $role == 'tutor' ? 'selected' : '' }}>
                                                {{ $tutor_name }}</option>
                                        </select>
                                    </div>
                                </div>
                            ...
                            <tbody>
                                @foreach ($users as $single)
                                    <tr>
                                        ...
                                        <td data-label="{{ __('general.email') }}"><span>{{ $single->email }}
                                        ...
                                        @php
                                            ...
                                            $content = $single->email_verified_at
                                                ? __('general.reject_account')
                                        ...
                                        <td @click="$wire.dispatch('showConfirm', { id : {{ $single->id }}, content: '{{ $content }}', type: '{{ $verified_at }}', action : 'verified-at-template' })"
                                            ...
                                            <a href="javascript:;" class="tb-email-verifiedbtn tk-project-tag"
                                                @if (!$single->email_verified_at) disabled @endif>
                                                <i class="icon-mail"></i>
                                        ...
                                        <td @click="$wire.dispatch('showConfirm', { id : {{ $single->id }}, content: `{{ $single->status == 'active' ? __('general.disable_user') : __('general.enable_user') }}`, type: '{{ $single->status }}', action : 'update-status' })"
                                            ...
                                            <em
                                                class="tk-project-tag {{ $single->status == 'active' ? 'tk-hourly-tag' : 'tk-fixed-tag' }}">{{ $single->status }}</em>
                                        </td>
                                        <td data-label="{{ __('general.identity_verification') }}">
                                            <div class="am-status-tag">
                                                <div class="am-status-tag">
                                                    <em
                                                        class="tk-project-tag {{ !empty($single->profile->verified_at) ? 'tk-hourly-tag' : 'tk-fixed-tag' }}">{{ !empty($single->profile->verified_at) ? __('general.verified') : __('general.non_verified') }}</em>
                                                </div>
                                            </div>
                                        </td>
                                        <td data-label="{{ __('general.actions') }}">
                                            ...
                                            content: '{{ __('general.delete_user') }}', icon: 'delete' })"
                                            ...
                                            <div class="am-custom-tooltip am-tooltip-textimp">
                                                ...
                                                content: '{{ __('admin/general.impersonate_user_confirm') }}', icon: 'warning', overrideClass:'am-impersonate' })"
                                                        class="icon-eye"></i>
                                                @endif
                                            </div>
                                        </td>
                            ...
                            <fieldset>
                                <div class="form-group-wrap">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text"
                                            class="form-control @error('form.phone') tk-invalid @enderror"
