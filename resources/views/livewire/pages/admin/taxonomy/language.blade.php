                            ...
                            <div class="tk-themeform__wrap">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control @error('name') tk-invalid @enderror "
                                        wire:model="name" required placeholder="{{ __('general.name') }}">
                                    @error('name')
                                        ...
                                        <div class="tb-email-status">
                                            ...
                                            <div class="tb-switchbtn">
                                                <label for="tb-emailstatus" class="tb-textdes"><span
                                                        id="tb-textdes">{{ $status == 'active' ? __('general.active') : __('general.deactive') }}</span></label>
                                                <input class="tb-checkaction"
                                                    {{ $status == 'active' ? 'checked' : '' }} type="checkbox"
                                                    id="tb-emailstatus">
                                            </div>
                                        </div>
                                        @error('status')
                    ...
                    <form class="tb-themeform tb-displistform">
                        <fieldset>
                            <div class="tb-themeform__wrap">
                                ...
                                <div class="tb-actionselect">
                                    <a href="javascript:;"
                                        class="tb-btn btnred {{ $selectedLanguages ? '' : 'd-none' }}"
                                        @click="$wire.dispatch('showConfirm', { action : 'delete-language' })">{{ __('general.delete_selected') }}</a>
                                </div>
                                ...
                                <div class="form-group tb-inputicon tb-inputheight">
                                    ...
                                    <input type="text" class="form-control" wire:model.live.debounce.500ms="search"
                                        autocomplete="off" placeholder="{{ __('taxonomy.search_here') }}">
                                </div>
                            </div>
                        </fieldset>
                    </form>
                                    ...
                                    <tr>
                                        <td data-label="{{ __('taxonomy.name') }}">
                                            <div class="tb-checkboxwithimg">
                                                <div class="tb-checkbox">
                                                    <input id="language_id{{ $single->id }}"
                                                        wire:model.lazy="selectedLanguages" value="{{ $single->id }}"
                                                        type="checkbox">
                                        ...
                                        <td data-label="{{ __('general.description') }}">
                                            <span>{!! $single->description !!}</span></td>
                                        ...
                                        <td data-label="{{ __('general.actions') }}">
                                            <ul class="tb-action-icon">
                                                ...
                                                <li> <a href="javascript:void(0);"
                                                        @click="$wire.dispatch('showConfirm', { id : {{ $single->id }}, action : 'delete-language' })"
                                                        class="tb-delete"><i class="icon-trash-2"></i></a> </li>
                                            </ul>
                                        </td>
                                    </tr>
                                @endforeach
