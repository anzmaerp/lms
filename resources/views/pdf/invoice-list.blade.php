                        ...
                        @if(!empty($invoice?->items))
                            <div class="tb-invoice-items" style="margin-top: 18px; width: 100%;">
                                <div class="tb-items-header" style="background: #f8f9fa; padding: 15px; font-weight: 600; border-radius: 10px;">
                                    <div class="tb-col tb-col-title" style="width: 57%; display: inline-block; vertical-align: top; text-align: left; color: #585858; font-weight: 500; font-family: 'Roboto', sans-serif; font-size: 14px; line-height: 20px;">{{ __('invoices.items') }}</div>
                                    <div class="tb-col tb-col-qty" style="width: 11%; display: inline-block; vertical-align: top; text-align: left; color: #585858; font-weight: 500; font-family: 'Roboto', sans-serif; font-size: 14px; line-height: 20px;">{{ __('invoices.invoice_qty') }}</div>
                                    <div class="tb-col tb-col-price" style="width: 16%; display: inline-block; vertical-align: top; text-align: left; color: #585858; font-weight: 500; font-family: 'Roboto', sans-serif; font-size: 14px; line-height: 20px;">{{ __('invoices.invoice_price') }}</div>
                                    <div class="tb-col tb-col-discount" style="width: 13%; display: inline-block; vertical-align: top; text-align: right; color: #585858; font-weight: 500; font-family: 'Roboto', sans-serif; font-size: 14px; line-height: 20px;">{{ __('invoices.amount') }}</div>
                                </div>
                                ...
                                <div class="tb-items-body">
                                    @foreach($invoice?->items as $item)
                                        ...
                                        <div class="tb-item-row" style="border-bottom: 1px solid #eee; padding: 14px 20px; overflow: hidden;">
                                            <div class="tb-col tb-col-title" data-label="{{ __('invoices.items') }}" style="width: 57%; display: inline-block; vertical-align: top; text-align: left; color: rgba(0, 0, 0, 0.7); font-weight: 400; font-family: 'Roboto', sans-serif; font-size: 14px; line-height: 20px;">
                                                {{ $item->title }}
                                            ...
                                            <div class="tb-col tb-col-qty" data-label="{{ __('invoices.invoice_price') }}" style="width: 11%; display: inline-block; vertical-align: top; text-align: left; color: rgba(0, 0, 0, 0.7); font-weight: 400; font-family: 'Roboto', sans-serif; font-size: 14px; line-height: 20px;">{{ $item->quantity}}</div>
                                            <div class="tb-col tb-col-price" data-label="{{ __('invoices.invoice_price') }}" style="width: 16%; display: inline-block; vertical-align: top; text-align: left; color: rgba(0, 0, 0, 0.7); font-weight: 400; font-family: 'Roboto', sans-serif; font-size: 14px; line-height: 20px;">
                                            ...
                                            <div class="tb-col tb-col-discount" data-label="{{ __('invoices.invoice_subtotal') }}" style="width: 13%; display: inline-block; vertical-align: top; text-align: right; color: rgba(0, 0, 0, 0.7); font-weight: 400; font-family: 'Roboto', sans-serif; font-size: 14px; line-height: 20px;">{{ formatAmount($item->total) }}</div>
                                        </div>
                                    @endforeach
                                    <div class="tb-item-row" style=" padding: 14px 20px;">
                                        <div class="tb-col tb-col-title" style="width: 57%; display: inline-block; vertical-align: top; text-align: left; color: rgba(0, 0, 0, 0.7); font-weight: 500; font-family: 'Roboto', sans-serif; font-size: 14px; line-height: 20px;"><strong style="font-weight: 600;">{{ __('invoices.invoice_subtotal') }}</strong></div>
                                        <div class="tb-col tb-col-price" style="width: 11%; display: inline-block; vertical-align: top; text-align: left; color: #585858; font-weight: 500; font-family: 'Roboto', sans-serif; font-size: 14px; line-height: 20px;"></div>
                                        <div class="tb-col tb-col-price" style="width: 16%; display: inline-block; vertical-align: top; text-align: left; color: #585858; font-weight: 500; font-family: 'Roboto', sans-serif; font-size: 14px; line-height: 20px;"></div>
                                        <div class="tb-col tb-col-qty" style="width: 13%; display: inline-block; vertical-align: top; text-align: right; color: #585858; font-weight: 500; font-family: 'Roboto', sans-serif; font-size: 14px; line-height: 20px;"><strong style="font-weight: 600;">{{ formatAmount($subTotal) }}</strong></div>
                                    </div>
                                </div>
                            </div>
                        @endif
