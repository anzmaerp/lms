                                ...
                                @if (
                                    ...
                                    <ul class="am-footer_contact">
                                        ...
                                        @if (!empty(setting('_front_page_settings.footer_address')))
                                            <li>
                                                <address><i class="am-icon-location"></i>{!! setting('_front_page_settings.footer_address') !!}
                                                </address>
                                            </li>
                                        @endif
                                    </ul>
                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="am-footer_info">
                                    <p>{{ $locale == 'ar' ? setting('_footer.copy_right_ar') : setting('_footer.copy_right_en') }}</p>
                                <nav>
                                    <ul>
                                        <li>
                    ...
                    <div class="col-12">
                        <div class="am-footer-content">
                            ...
                            @if (
                                ...
                                <div class="am-actions" data-aos="fade-up" data-aos-duration="600"
