...
return [
    ...
    'registration_student_content' => 'نحن متحمسون لانضمامك إلى مجتمع ashal، :userName! يرجى التحقق من عنوان بريدك الإلكتروني بالنقر على الرابط التالي: :verificationLink نتطلع لرؤيتك تحقق أهدافك التعليمية.',
    'registration_tutor_content' => 'نحن سعداء بترحيبك كمدرب في ashal، :userName! لإكمال تسجيلك، يرجى التحقق من عنوان بريدك الإلكتروني بالنقر على الرابط التالي: :verificationLink نحن متحمسون لرؤية التأثير الإيجابي الذي ستحدثه على رحلات تعلم طلابك.',
    ...
    'welcome_student_subject' => 'مرحبًا بك في Ashal online  ، {username}!',
    'welcome_tutor_subject' => 'مرحبًا بك في Ashal Online ، {username}!',
    ...
    'dispute_tutor_subject' => 'سبب النزاع تأكيد للحجز مع {{studentName}',
    'dispute_tutor_content' => 'تم رفع نزاع من قبل {{studentName} بخصوص جلستك الأخيرة. لقد وضعنا الدفعة في الانتظار أثناء مراجعة المشكلة. <br> <br> سبب النزاع: <br> {disputereason} <br> <br> يرجى تسجيل الدخول إلى لوحة القيادة الخاصة بك لعرض المزيد من التفاصيل وتقديم ردك إذا لزم الأمر. <br> <br>',
    'admin_dispute_tutor_subject' => 'نزاع جديد تم تقديمه للجلسة مع {StudentName} و {tutorname}',
    'admin_dispute_tutor_variables' => '{StudentName} - للحصول على اسم الطالب <br> {tutorname} - للحصول على اسم المعلم <br> {sessionDateTime} - لتاريخ الجلسة والوقت <br> {dispustereason} - لسبب النزاع',
    'admin_dispute_tutor_content' => 'تم تقديم نزاع جديد للجلسة بين {{studentName} و {tutorname}. فيما يلي تفاصيل النزاع: <br> <br> تفاصيل الجلسة: <br> المعلم: {tutorname} <br> الطالب: {StudentName} <br> التاريخ والوقت: {sessionDateTime} <br> سبب النزاع:',
    'dispute_resolution_title' => 'إشعار تسوية المنازعات',
    'dispute_resolved_student_subject' => 'تم حل النزاع - استرداد صدر لجلستك مع :tutorName',
    'dispute_resolved_student_content' => 'عزيزي :studentName ، <br> تم حل نزاعك للجلسة مع :tutorName لصالحك. تم إصدار استرداد :refundAmount إلى طريقة الدفع الأصلية الخاصة بك. <br> تفاصيل الجلسة: <br> الرسالة: :disputeReason <br> Tutor: :tutorName <br> التاريخ والوقت: :sessionDateTime <br> REWNED صدر: :refundAmount <br>',
    'dispute_resolve_student_variables' => 'أسماء المتغيرات المحتملة: {{{studentName}} ، {{tutorname}} ، {{sessionDateTime}} ، {{refundamount}} ،',
    'dispute_resolved_tutor_subject' => 'تم حل النزاع - تم إصدار الدفع للجلسة مع :studentName',
    'dispute_resolved_tutor_content' => 'عزيزي/عزيزتي :tutorName,<br>تم حل النزاع المرفوع بخصوص الجلسة مع :studentName لصالحك. تم تحويل الدفعة الخاصة بالجلسة إلى محفظتك.<br>تفاصيل الجلسة:<br>الرسالة: :disputeReason<br>الطالب: :studentName<br>التاريخ والوقت: :sessionDateTime<br>المبلغ المحول: :paymentAmount<br><br>شكرًا لك على صبرك خلال عملية المراجعة.<br><br>مع أطيب التحيات،<br>فريق Ashal Online',
