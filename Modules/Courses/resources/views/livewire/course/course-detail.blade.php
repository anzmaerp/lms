<div class="cr-course-details-page">
    <div class="cr-course-content">
        <div class="cr-course-details-wrapper">
            <section class="cr-course-details-banner">
                <img src="{{ asset('modules/courses/images/bg-shap.svg') }}" alt="Course preview image"
                    class="cr-course-shap-image" />
                <img src="{{ asset('modules/courses/images/bg-shap2.svg') }}" alt="Course preview image"
                    class="cr-course-shap-image2" />
                        ...
                        <div class="cr-course-meta">
                            ...
                            @if (!empty($course->updated_at))
                                <div class="cr-last-updated">
                                    ...
                                    <span class="cr-update-date">{{ __('courses::courses.last_updated') }}:
                        ...
                        <div class="cr-course-stats">
                            ...
                            <div class="cr-stat-item">
                                ...
                                <div class="cr-stat-content">
                                    ...
                                    @else
                                        <span
                                            class="cr-stat-value">{{ __('courses::courses.no_enrolled_students') }}</span>
                                    @endif
                                </div>
                            </div>
                            <div class="cr-stat-item">
                    ...
                    <div class="cr-course-details-area">
                        <ul class="am-aboutuser_tab" x-data="{ tab: 'overview' }">
                            <li x-bind:class="tab == 'overview' ? 'active' : ''">
                                <a href="#overview" @click="tab='overview'"
                                    class="am-tabitem">{{ __('courses::courses.overview') }}</a>
                            </li>
                            <li x-bind:class="tab == 'objectives' ? 'active' : ''">
                                <a href="#objectives" @click="tab='objectives'"
                                    class="am-tabitem">{{ __('courses::courses.objectives') }}</a>
                            </li>
                            <li x-bind:class="tab == 'course-curriculum' ? 'active' : ''">
                                <a @click="tab='course-curriculum'" href="#course-curriculum"
                                    class="am-tabitem">{{ __('courses::courses.course_curriculum') }}</a>
                            </li>
                            <li x-bind:class="tab == 'prerequisites-&-faq' ? 'active' : ''">
                                <a @click="tab='prerequisites-&-faq'" href="#prerequisites-&-faq"
                                    class="am-tabitem">{{ __('courses::courses.prerequisites_and_faqs') }}</a>
                            </li>
                            <li x-bind:class="tab == 'reviews' ? 'active' : ''">
                                <a @click="tab='reviews'" href="#reviews"
                                    class="am-tabitem">{{ __('courses::courses.reviews') }}</a>
                            </li>
                        </ul>
                    </div>
                </div>
                <div class="cr-course-details-area">
                    <div class="cr-overview am-tutor-detail">
                        @if (!empty($course->description))
                            <div class="cr-overview-course" id="overview">
                                ...
                                @if (strlen(strip_tags($course->description)) > 400)
                                    <a href="javascript:void(0);" class="cr-show"
                                        wire:click.prevent="toggleDescription">
                                            ...
                                            @foreach ($course->sections as $index => $section)
                                                <div class="accordion-item">
                                                    <input type="radio"
                                                        ...
                                                        name="curriculum-accordion" id="section-{{ $section->id }}"
                                                    ...
                                                    <label for="section-{{ $section->id }}"
                                                        ...
                                                        <span class="accordion-icon">
                                                            <svg width="18" height="18" viewBox="0 0 18 18"
                                                                fill="none">
                                                                <path d="M4.5 6.75L9 11.25L13.5 6.75" stroke="#585858"
                                                                                ...
                                                                                <div class="cr-div">
                                                                                    @if (in_array($curriculum->type, ['video', 'yt_link', 'vm_link']))
                                                                                        <svg width="15"
                                                                                            ...
                                                                                            <g opacity="0.8">
                                                                                                <path
                                                                                                    d="M1.875 11.0711V4.92885C1.875 3.68539 1.875 3.06366 2.13554 2.71064C2.36269 2.40287 2.71108 2.20748 3.09214 2.17415C3.52922 2.13591 4.05974 2.46012 5.12076 3.10852L10.1463 6.17967C11.1311 6.78153 11.6236 7.08246 11.7914 7.46987C11.938 7.80809 11.938 8.19191 11.7914 8.53013C11.6236 8.91754 11.1311 9.21847 10.1463 9.82034L5.12076 12.8915C4.05974 13.5399 3.52922 13.8641 3.09214 13.8259C2.71108 13.7925 2.36269 13.5971 2.13554 13.2894C1.875 12.9363 1.875 12.3146 1.875 11.0711Z"
                                                                                                    stroke="#585858"
                                                                                                    stroke-width="1.5"
                                ...
                                <div class="cr-faq-accordion cr-detail-faq-accordion">
                                    <div class="accordion">
                                        @foreach ($course->faqs as $index => $faq)
                                            <div class="accordion-item">
                                                <input type="radio" @if ($index == 0) checked @endif
                                                    name="accordion" id="faq-{{ $faq->id }}"
                                                    class="accordion-checkbox">
                        ...
                        @if (!empty($course->ratings) && $course?->ratings?->count() > 0)
                            <div x-data="{
                            ...
                            }" class="cr-overview-course cr-overview-rating"
                                id="reviews">
                                ...
                                @foreach ($course->ratings as $index => $rating)
                                    <div class="cr-review" @if ($index >= 4) x-show="showMore" @endif>
                                        @if (
                                            !empty($rating->student?->profile?->image) &&
                                                Storage::disk(getStorageDisk())->exists($rating->student?->profile?->image))
                                            <img src="{{ Storage::url($rating->student?->profile?->image) }}"
                                                alt="{{ $rating->student?->profile?->full_name }}">
                                        @else
                                            <img src="{{ resizedImage('placeholder.png', 42, 42) }}"
                                                alt="{{ $rating->student?->profile?->full_name }}" />
                                        @endif
                                                    ...
                                                    <div class="cr-review-name">
                                                        ...
                                                        @if (!empty($rating?->student?->address?->country?->short_code))
                                                            <div class="am-custom-tooltip">
                                                                ...
                                                                <span
                                                                    class="flag flag-{{ strtolower($rating?->student?->address?->country?->short_code) }}"></span>
                                                            </div>
                                                        @endif
                                                    </div>
                                ...
                                @if ($course->ratings?->count() > 4)
                                    <a href="javascript:void(0);" @click="showMoreRatings()" class="cr-review-button"
                                        x-text="showMore ? '{{ __('courses::courses.show_less') }}' : '{{ __('courses::courses.show_more') }}'"></a>
                                @endif
                            </div>
                        @endif
                    </div>
                    ...
                    <div class="cr-course-sidebar">
                        <div class="cr-course-card" x-data="{ showVideo: false }" x-init="setTimeout(() => showVideo = true, 500)">
                            <figure class="cr-image-wrapper" x-data="{
                                ...
                                <template x-if="isOpen">
                                    <div class="cr-video-modal">
                                        <video :id="'course-' + courseId"
                                            onloadeddata="let player = videojs(this); player.removeClass('d-none'); setTimeout(() => player.play(), 100);"
                                            class="d-none video-js vjs-default-skin d-none-playBtn" width="100%"
                                            height="100%" controls>
                                ...
                                <template x-if="!isOpen">
                                    <img height="200" width="360"
                                        src="{{ !empty($course?->thumbnail?->path) ? url(Storage::url($course?->thumbnail?->path)) : asset('module/courses/images/course.png') }}"
                            ...
                            <div class="cr-course-details">
                                @if (isPaidSystem() &&
                                        !empty($course->pricing?->price) &&
                                        !empty($course->pricing?->final_price) &&
                                        $course->pricing?->price != 0.0)
                                    <div class="cr-price-section">
                                        <div class="cr-price-wrapper">
                                            <div class="cr-price">
                                                <span class="cr-currency">{{ getCurrencySymbol() }}</span>
                                                <span
                                                    class="cr-amount">{{ number_format($course->pricing?->final_price, 2) }}
                                                </span>
                                            </div>
                                            @if (!empty($course->pricing?->price) && !empty($course->pricing?->discount))
                                                <del
                                                    class="cr-discount">{{ number_format($course->pricing?->price, 2) }}</del>
                                            @endif
                                        </div>
                                        @if (!empty($course->pricing?->discount))
                                            <div class="cr-discount-label">{{ $course->pricing?->discount }}%
                                                {{ __('courses::courses.off') }}</div>
                                        @endif
                                    </div>
                                @else
                                    <div class="cr-price-wrapper">
                                        ...
                                        @if (!empty($course->sections_count))
                                            <li class="cr-includes-item">
                                                ...
                                                <div class="cr-includes-text">
                                                    <span
                                                        class="cr-includes-value">{{ $course->sections_count }}</span>
                                                    <span
                            ...
                            <div class="cr-action-buttons">
                                @auth
                                    @if ($viewCourse)
                                        <a href="{{ route('courses.course-taking', ['slug' => $course->slug, 'redirect' => 'course-detail']) }}"
                                            class="am-btn">
                                    ...
                                    @elseif($isBuyable)
                                        ...
                                        @else
                                            @if (isPaidSystem())
                                                <button class="am-btn" wire:click="addToCart"
                                                    wire:loading.attr="disabled" wire:loading.class="am-btn_disable"
                                                    wire:target="addToCart">
                                                    {{ __('courses::courses.add_to_cart') }}
                                                </button>
                                            @else
                                                <button class="am-btn" wire:click="enrollCourse"
                                                    wire:loading.attr="disabled" wire:loading.class="am-btn_disable"
                                                    wire:target="addToCart">
                                        ...
                                        @endif
                                    @endif
                                    <a href="{{ route('login', ['redirect' => request()->fullUrl()]) }}" class="am-btn">
                                        {{ __('courses::courses.login_required') }}
                                    </a>
                                @endauth
                            </div>
                        </div>
                                            ...
                                            <div class="am-tutorreview-item_icon">
                                                <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18"
                                                    ...
                                                    <g opacity="0.7">
                                                        ...
                                                        <path
                                                            d="M7.18201 7.23984C7.18201 6.4545 8.04578 5.97564 8.71184 6.39173L11.5295 8.15195C12.1564 8.54359 12.1564 9.45654 11.5295 9.84817L8.71184 11.6084C8.04578 12.0245 7.18201 11.5456 7.18201 10.7603V7.23984Z"
                                                            stroke="#585858" stroke-width="1.5"
                                                            stroke-linecap="round" stroke-linejoin="round"></path>
                                                    </g>
                                                </svg>
                                                ...
                                                <div class="wa-tags-list">
                                                    <ul>
                                                        ...
                                                        @if ($course->instructor->languages->count() > 2)
                                                            <li><span>+{{ $course->instructor->languages->count() - 2 }}
                                                                    {{ __('courses::courses.more') }}</span></li>
                                                        @endif
                                                    </ul>
                                                </div>
                                            </div>
                        ...
                        <div class="share-course-container">
                            ...
                            <div class="share-icons-container" x-data="{ copied: false, textToCopy: '{{ route('courses.course-detail', ['slug' => $course->slug]) }}' }">
                                <button class="share-icon cr-facebook" aria-label="Share on Facebook"
                                    onclick="window.open('https://www.facebook.com/sharer/sharer.php?u={{ urlencode(route('courses.course-detail', ['slug' => $course->slug])) }}', '_blank', 'width=600,height=400')">
                                    <i class="am-icon-facebook-1"></i>
                                    <span class="am-tooltip-text">
                                        <span>{{ __('courses::courses.facebook') }}</span>
                                    </span>
                                </button>
                                <button class="share-icon cr-twitter" aria-label="Share on Twitter"
                                    onclick="window.open('https://twitter.com/intent/tweet?url={{ urlencode(route('courses.course-detail', ['slug' => $course->slug])) }}&text={{ urlencode($course->title) }}', '_blank', 'width=600,height=400')">
                                    <i class="am-icon-twitter-02"></i>
                                    <span class="am-tooltip-text">
                                        <span>{{ __('courses::courses.twitter') }}</span>
                                    </span>
                                </button>
                                <button class="share-icon cr-linkedin" aria-label="Share on LinkedIn"
                                    onclick="window.open('https://www.linkedin.com/shareArticle?mini=true&url={{ urlencode(route('courses.course-detail', ['slug' => $course->slug])) }}&title={{ urlencode($course->title) }}', '_blank', 'width=600,height=400')">
                                    <i class="am-icon-linkedin-02"></i>
                                    <span class="am-tooltip-text">
                                        <span>{{ __('courses::courses.linkedin') }}</span>
                                    </span>
                                </button>
                                <button class="share-icon cr-instagram" aria-label="Share via Instragram"
                                    onclick="window.open('https://www.instagram.com/sharer?url={{ urlencode(route('courses.course-detail', ['slug' => $course->slug])) }}', '_blank', 'width=600,height=400')">
                                    <i class="am-icon-instagram"></i>
                                    <span class="am-tooltip-text">
                                        <span>{{ __('courses::courses.instagram') }}</span>
                                    </span>
                                </button>
                                <button class="more-options" aria-label="Copy Link"
                                    @click="navigator.clipboard.writeText(textToCopy).then(() => { copied = true; setTimeout(() => copied = false, 2000) }).catch(() => {})">
                                    <template x-if="copied">
                                        <span class="fw-bookmark fw-invite" x-show="copied"
    ...
    <div wire:ignore.self class="modal fade cr-promotional-video" id="videoModal" tabindex="-1"
    ...
    <!-- Article Modal -->
    <div wire:ignore.self class="modal fade cr-article-modal" id="articleModal" tabindex="-1"
