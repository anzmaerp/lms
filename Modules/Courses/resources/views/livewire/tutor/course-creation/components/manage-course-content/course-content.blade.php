    <div wire:init="loadData">
        <div class="cr-course-box">
                    ...
                    <div wire:key="section-{{ $section->id }}" id="section-{{ $section->id }}" class="cr-faq-accordion">
                        <div class="cr-formarea accordion">
                            <div class="accordion-item">
                                ...
                                <label for="{{ 'accordion-item-' . $section->id }}"
                                        ...
                                        <ul class="am-itemdropdown_list dropdown-menu"
                                            ...
                                            <li>
                                                <a href="javascript:void(0);" class="cr-delete-curriculum"
                                                    data-id="{{ $section->id }}" data-component_id="@this">
                                                    <i>
                                                        <svg xmlns="http://www.w3.org/2000/svg" width="20"
                                                            height="20" viewBox="0 0 20 20" fill="none">
                                                            <path
                                ...
                                <div class="accordion-content">
                                    <livewire:courses::manage-course-content.components.curriculum :id="$section->id"
                                        :section="$section" :key="now() . $section->id . 'curriculum'" />
                                </div>
                                </label>
                            </div>
                        </div>
                ...
                @if ($addSection)
                    <div class="cr-formarea">
                        ...
                        <div class="form-group @error('description') cr-invalid @enderror">
                            <label class="am-important"
                                for="description*">{{ __('courses::courses.description') }}</label>
                        ...
                        <div class="cr-btns">
                            <button wire:click="addSectionState(false)" wire:loading.class="am-btn_disable"
                                wire:target="addSectionState(false)"
                                class="am-cancel-btn">{{ __('courses::courses.cancel') }}</button>
                            <button wire:click="createSection" type="submit" class="am-btn">
                                <span wire:loading
                                    wire:target="createSection">{{ __('courses::courses.loading') }}</span>
                                <span wire:loading.remove
                                    wire:target="createSection">{{ __('courses::courses.add_section') }}</span>
                            </button>
                        </div>
                    </div>
                @else
            ...
            <div class="am-themeform_footer">
                <a
                    href="{{ route('courses.tutor.edit-course', ['tab' => isPaidSystem() ? 'pricing' : 'media', 'id' => $course->id]) }}">
                    <button class="am-white-btn">
                        <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 18 18"
                            fill="none">
                            <path d="M10.5 4.5L6 9L10.5 13.5" stroke="#585858" stroke-width="1.5"
                                stroke-linecap="round" stroke-linejoin="round" />
                        </svg>
            ...
            <div class="modal-dialog modal-dialog-centered">
                <div class="modal-content">
                                ...
                                <div class="form-group @error('description') cr-invalid @enderror">
                                    <div wire:ignore class="am-editor-wrapper">
                                        <div class="am-custom-editor am-custom-textarea">
                                            <textarea id="edit_section_description" data-id="@this" data-model_id="description"
                                                class="form-control cr-summernote" placeholder="{{ __('courses::courses.enter_answer') }}"></textarea>
                                            <span class="characters-count"></span>
                                        </div>
                                    </div>
                    ...
                    <div class="modal-footer">
                        ...
                        <button type="button" class="am-btn" wire:click="updateSection"
        ...
        <div wire:ignore.self class="modal fade cr-course-modal cr-course-del-modal" id="delete-confirm-modal"
            ...
            <div class="modal-dialog modal-dialog-centered">
                <div class="modal-content">
                    ...
                    <div class="modal-footer">
                        <button type="button" class="am-white-btn"
                            data-bs-dismiss="modal">{{ __('courses::courses.no') }}</button>
    ...
    @push('styles')
        ...
        @vite(['public/summernote/summernote-lite.min.css', 'public/css/videojs.css'])
    @endpush
    @push('scripts')
